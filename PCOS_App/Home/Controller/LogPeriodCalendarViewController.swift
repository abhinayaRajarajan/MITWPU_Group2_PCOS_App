...
class LogPeriodCalendarViewController: UIViewController {
    ...
    private func setupDisplayedMonths() {
        ...
        // Show previous 2 months and next 2 months
    ...
    private func setupCollectionView() {
        ...
        collectionView.register(CalendarWeekdayHeader.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: "WeekdayHeader")
...
extension LogPeriodCalendarViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        if indexPath.item == 0 {
            ...
            let header = collectionView.dequeueReusableSupplementaryView(ofKind: kind, withReuseIdentifier: "MonthHeader", for: indexPath) as! CalendarMonthHeader

            let monthDate = displayedMonths[indexPath.section]

            header.configure(with: monthDate)
            ...
            let header = collectionView.dequeueReusableSupplementaryView(ofKind: kind, withReuseIdentifier: "WeekdayHeader", for: indexPath) as! CalendarWeekdayHeader
...
extension LogPeriodCalendarViewController: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, referenceSizeForHeaderInSection section: Int) -> CGSize {
        ...
        if section == 0 {
            ...
            return CGSize(width: collectionView.bounds.width, height: 90) // Month + Weekday headers

        }

        return CGSize(width: collectionView.bounds.width, height: 70) // Just month header
    ...
    func configure(with date: Date?, isToday: Bool, isSelected: Bool) {
        ...
        if isSelected {
            ...
            if isToday {
                ...
                selectionView.layer.borderColor = UIColor.systemPink.cgColor
            ...
            if isToday {
                ...
                // Empty circle for today when not selected
...
// MARK: - CalendarWeekdayHeader

class CalendarWeekdayHeader: UICollectionReusableView {
