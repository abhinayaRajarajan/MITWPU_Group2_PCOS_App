...
class ProteinViewController: UIViewController {
    ...
    @IBOutlet weak var ProteinDisclaimerView: UIView!
    @IBOutlet weak var ProteinFoodsView: UIView!
    @IBOutlet weak var ProteinInfoView: UIView!
    ...
    override func viewDidLoad() {
        ...
        ProteinInfoView.layer.cornerRadius = 30
        ProteinInfoView.clipsToBounds = true
        
        ProteinFoodsView.layer.cornerRadius = 30
        ProteinFoodsView.clipsToBounds = true
        
        ProteinDisclaimerView.layer.cornerRadius = 30
        ProteinDisclaimerView.clipsToBounds = true
