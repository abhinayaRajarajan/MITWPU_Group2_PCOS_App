...
//enum GoalType { case steps case calories case duration } extension GoalType { var title: String { switch self { case .steps: return "Step Count" case .calories: return "Calories Burnt" case .duration: return "Workout Duration" } } var unit: String { switch self { case .steps: return "steps" case .calories: return "cal" case .duration: return "min" } } var maxValue: Int { switch self { case .steps: return 800 case .calories: return 300 case .duration: return 120 } } var barColor: UIColor { switch self { case .steps: return .systemPurple case .calories: return .systemPink case .duration: return .systemOrange } } }
enum GoalType {
    case steps
    case calories
    case duration
...
extension GoalType {
    ...
    var maxValue: Int {
        ...
        case .calories: return 300
        case .duration: return 120
        }
    }

    var barColor: UIColor {
        switch self {
        case .steps: return .systemPurple
        case .calories: return .systemPink
        case .duration: return .systemOrange
        }
    }
}
