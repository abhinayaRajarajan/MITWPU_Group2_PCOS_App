...
class AddDescribedMealViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        title = "Add: \(foodItem.name), labeled: \(label ?? "null")"
    }
    ...
    private func setupHeader() {
        ...
        if let food = food {
                ...
                print("DEBUG: setupHeader - Configured with Food")
            } else if let foodItem = foodItem {
                headerView.configure(with: foodItem)
                print("DEBUG: setupHeader - Configured with FoodItem")
            } else {
    ...
    extension AddDescribedMealViewController: UITableViewDelegate, UITableViewDataSource {
        ...
        func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
            ...
            if !ingredients.isEmpty {
                ...
                print("DEBUG: Tapped ingredient: \(ingredient)")
...
//                    ingredientDisplay = "\(ingredient.name) (\(quantity) \(unit))"
//                } else {
...
//                    updatedIngredient.unit = unitText.isEmpty ? nil : unitText
            ...
            private func recalculateMacros() {
                // TODO: Implement macro recalculation based on remaining ingredients
                // This would involve summing up calories, protein, carbs, fat from remaining ingredients
                // and updating the header view
                print("DEBUG: Recalculating macros for \(ingredients.count) ingredients")
            }
